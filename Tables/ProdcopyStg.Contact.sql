...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__Contact__copyloa__0A9D95DB] DEFAULT (getdate()),
...
GO
ALTER TABLE [ProdcopyStg].[Contact] ADD CONSTRAINT [PK__Contact__7126F91D2EB01742] PRIMARY KEY CLUSTERED  ([contactid])
GO
