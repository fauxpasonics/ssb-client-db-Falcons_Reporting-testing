...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__Account__copyloa__2BFE89A6] DEFAULT (getdate()),
...
GO
ALTER TABLE [ProdcopyStg].[Account] ADD CONSTRAINT [PK__Account__F20699F6609CCEF7] PRIMARY KEY CLUSTERED  ([accountid])
GO
