...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__Contact__copyloa__07C12930] DEFAULT (getdate()),
...
[new_preferredlanguage] [int] NULL,
[new_preferredlanguagename] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[new_livea_race] [nvarchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[new_livea_gender] [int] NULL,
[new_livea_gendername] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[new_livea_haschildren] [bit] NULL,
[new_livea_haschildrenname] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
)
GO
ALTER TABLE [Prodcopy].[Contact] ADD CONSTRAINT [PK__Contact__7126F91D739CD9DF] PRIMARY KEY CLUSTERED  ([contactid])
GO
